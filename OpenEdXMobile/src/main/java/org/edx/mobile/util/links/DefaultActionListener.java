...
public class DefaultActionListener implements URLInterceptorWebViewClient.ActionListener {
    ...
    public DefaultActionListener(@ActivityContext @NonNull FragmentActivity activity, @NonNull View progressWheel,
        ...
        this.environment = EntryPointAccessors.fromApplication(activity, EdxDefaultModule.ProviderEntryPoint.class).getEnvironment();
        this.courseService = EntryPointAccessors.fromApplication(activity, EdxDefaultModule.ProviderEntryPoint.class).getCourseService();
        this.courseApi = EntryPointAccessors.fromApplication(activity, EdxDefaultModule.ProviderEntryPoint.class).getCourseAPI();
    }
